Shader "DearImGui/Mesh"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.pearworks.dear-imgui/Resources/Shaders/PassesUniversal.hlsl"
            ENDHLSL
        }
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex ImGuiPassVertex
            #pragma fragment ImGuiPassFrag
            #include "Packages/com.pearworks.dear-imgui/Resources/Shaders/PassesBuiltin.hlsl"
            ENDCG
        }
    }
}
